...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/compmusic/icons/dunya.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color: rgb(228, 228, 228)"))
        ...
        self.menubar_makam.setGeometry(QtCore.QRect(0, 0, 680, 25))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Dunya Desktop", None))
