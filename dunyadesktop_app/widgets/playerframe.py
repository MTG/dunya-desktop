...
from widgets.widgetutilities import (read_audio, load_pitch, load_pd,
                                     load_tonic, get_feature_paths, load_notes)
...
class PlayerFrame(QFrame):
    ...
    def __set_waveform(self):
        (raw_audio, len_audio, min_audio,
         max_audio) = read_audio(self.feature_paths['audio_path'])
